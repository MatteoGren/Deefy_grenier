...
try {
    $pdo = new PDO("mysql:host=db;dbname=deefy;charset=utf8", "user", "password");
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    // Désactivation temporaire des clés étrangères
    ...
    $sqlStatements = [
        ...
        "INSERT INTO `playlist2track` (`id_pl`, `id_track`, `no_piste_dans_liste`) VALUES
            (1,1,1),(1,2,2),(2,3,1),(2,4,2),(3,5,1),(3,6,2),(4,7,1),(4,8,2);",
